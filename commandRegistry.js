const categories = {
  ...
  hiburan: {
    ...
    commands: [
      ...
      ['.heist / .rampokbank [1-4]', 'Misi bobol target bank bertingkat (ATM, Cabang, Sentral, Royal Vault)'],
      ['.joinheist / .startheist', 'Gabung regu / mulai serbuan target bank yang dipilih'],
