...
const anchor = \if (isGroup && (cleanCmd === 'open' || cleanCmd === 'close')) {\;
...
if (content.includes(anchor) && !content.includes("cleanCmd === 'fitur'")) {
    ...
    console.log('anchor not found or already patched in groupAdminHandler.js');
}
